package com.employeehub.gateway.config;
...
/**
 * Prints a clean, colored banner once the gateway is fully started.
 */
@Component
public class StartupBanner implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        System.out.println("   " + dim + "Gateway  " + reset + " : " + cyan + "http://localhost:" + port + reset);
